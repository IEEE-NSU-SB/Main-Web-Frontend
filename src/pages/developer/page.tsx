...
const developers = [
	{
		...
		quote: "\"Rising through Resilience, Inspiring Every Stride\"",
    image: luffy,
		social: {
			github: "https://github.com/rahiqrahman",
			linkedin: "https://linkedin.com/in/rahiqrahman",
			facebook: "https://facebook.com/rahiqrahman"
		}
	},
	{
    ...
    image: luffy,
		social: {
			github: "https://github.com/shakibjunayed",
			linkedin: "https://linkedin.com/in/shakibjunayed",
			facebook: "https://facebook.com/shakibjunayed"
		}
	},
	{
		name: "Rahiq Rahman",
...
export default function DeveloperPage() {
	...
	const developerColors = useMemo(() => {
		return developers.map(() => getRandomLightColor());
	}, []);
			...
			<section className="max-w-[1100px] mx-auto px-5 py-15 sm:px-8 pb-16 sm:pb-24">
				...
				<div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-15">
					{developers.map((developer, index) => {
						const randomColor = developerColors[index];
						return (
						<div
