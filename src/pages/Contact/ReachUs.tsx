            ...
            <div className="main_div flex md:flex-row flex-col gap-5">
                ...
                <div className="contact_div w-full md:w-1/2">
                    ...
                    <form>
                        ...
                        <p className='font-semibold text-xl mt-[15px]'>Your Email</p>
                        ...
                        <p className='font-semibold text-xl mt-[15px]'>Your Message</p>
                        ...
                        <div className='flex justify-end'>
                            <input className="text-[14px]   bg-[#002855] font-bold rounded-sm text-white w-[150px] border-2 border-[#002855] transition-all duration-300 mt-3 py-3 px-0 
                        hover:bg-white hover:text-[#002855] hover:border-[#002855]" type="submit" value="SUBMIT" />
                        </div>
                    </form>
