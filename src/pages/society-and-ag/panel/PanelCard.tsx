...
const PanelCard: React.FC<PanelCardProps> = ({ members, color, sectionTitle }) => {
  if (!members || members.length === 0) return null; // don't render if no members
  return (
    <div className="flex justify-center my-10">
      <div className="flex flex-col max-w-[1140px] w-full">
        <SectionHeading title={sectionTitle} align="center" titleColor={color} underlineColor={color}/>
