...
import { Calendar, DollarSign, Info, Facebook, Linkedin, Mail } from 'lucide-react';
                        ...
                        <div className="max-w-sm mx-auto">
                            <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                                ...
                                <div className="px-6 pb-6">
                                    <button className="w-full bg-[#002855] hover:bg-[#003366] text-white font-bold py-4 px-6 rounded transition-colors duration-200">
                                        REGISTER
                                    </button>
